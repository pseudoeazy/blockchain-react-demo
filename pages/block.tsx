      ...
      <main className="min-h-screen w-10/12 mx-auto mt-8">
        ...
        <article className="mt-4">
          ...
          <p className="mt-3 text-base">
            ...
            group your data in a small unit called a block. The collection of a
            block forms a blockchain. The data you added to the blockchain is
            called a transaction.
          </p>
          <p className="mt-3 text-base">
            When a computer that is connected to the blockchain is given a data
            to add to the blockchain, it will have to be validated before it can
            be added.
          </p>
          <p className="mt-3 text-base">
